...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.eHentai = exports.getEHentaiInfo = exports.getExportVersion = void 0;
...
const getEHentaiInfo = (useExHentai) => ({
...
exports.getEHentaiInfo = getEHentaiInfo;
class eHentai {
    constructor(cheerio) {
        this.cheerio = cheerio;
        this.requestManager = App.createRequestManager({
            ...
            interceptor: {
                interceptRequest: async (request) => {
                    const useExHentai = await (0, eHentaiSettings_1.getUseExHentai)(this.stateManager);
                    ...
                    if (useExHentai) {
                        const ipbMemberId = await (0, eHentaiSettings_1.getIpbMemberId)(this.stateManager);
                        const ipbPassHash = await (0, eHentaiSettings_1.getIpbPassHash)(this.stateManager);
                        cookies.push(App.createCookie({ name: 'ipb_member_id', value: ipbMemberId, domain: 'exhentai.org' }), App.createCookie({ name: 'ipb_pass_hash', value: ipbPassHash, domain: 'exhentai.org' }));
                    }
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.resetSettings = exports.settings = exports.getIpbPassHash = exports.getIpbMemberId = exports.getUseExHentai = exports.getDisplayedCategoriesStr = exports.getDisplayedCategories = exports.getExtraArgs = void 0;
const eHentaiHelper_1 = require("./eHentaiHelper");
...
async function getUseExHentai(stateManager) {
    return await stateManager.retrieve('use_exhentai') ?? false;
}
exports.getUseExHentai = getUseExHentai;
